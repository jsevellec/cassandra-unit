...
The version number now tracks the **embedded Cassandra major**, not the driver version. 5.0.0
...
in [Getting started](getting-started.md#2-configure-surefire-mandatory).
